...
import ir.nextpeyk.android.ui.theme.AmberColor
import ir.nextpeyk.android.ui.theme.AmberSoft
import ir.nextpeyk.android.ui.theme.GreenSoft
...
val sampleShipments = listOf(
    Shipment("PASR8875676545", "بهار محمدی", ShipmentTone.Accent, "در راه", 1,
        ...
        "۲٫۴ کیلومتر", "رضا کریم", "۱۲ دقیقه", 35.7570, 51.4140),
    Shipment("PASR4471209983", "آرمان رستمی", ShipmentTone.Amber, "در انتظار", 0,
        ...
        "۱٫۱ کیلومتر", "سمیرا اکبری", "۲۵ دقیقه", 35.7600, 51.4040),
    Shipment("PASR1183440072", "مهسا توکلی", ShipmentTone.Green, "تحویل شد", 2,
        ...
        "۳٫۸ کیلومتر", "حسین نوری", "تحویل‌شده", 35.8060, 51.4320),
    Shipment("PASR7765540021", "کیان داوری", ShipmentTone.Green, "تحویل شد", 2,
        ...
        "۰٫۹ کیلومتر", "مریم صادقی", "تحویل‌شده", 35.7540, 51.4100),
    Shipment("PASR3098871254", "سارا مرادی", ShipmentTone.Muted, "لغو شد", 0,
        ...
        "۱٫۶ کیلومتر", "—", "لغو‌شده", 35.7755, 51.4100),
    Shipment("PASR6612309871", "نیلوفر احمدی", ShipmentTone.Accent, "در راه", 1,
        "انبار جنوب تهران، خیابان شوش، نرسیده به میدان شوش، پلاک ۴۵",
        "تهران، نارمک، خیابان هنگام، کوچه دوم، پلاک ۱۱",
        "۴٫۲ کیلومتر", "علی رضایی", "۱۸ دقیقه", 35.7310, 51.4870),
    Shipment("PASR2234567890", "فریدون کاظمی", ShipmentTone.Amber, "در انتظار", 0,
        "انبار شمال تهران، تجریش، کوچه یازدهم، ساختمان الوند",
        "تهران، یوسف‌آباد، خیابان بیست و سوم، پلاک ۶۲",
        "۲٫۷ کیلومتر", "زهرا حسینی", "۳۰ دقیقه", 35.7450, 51.4000),
    Shipment("PASR5543219876", "شیرین محمودی", ShipmentTone.Green, "تحویل شد", 2,
        "انبار مرکزی تهران، خیابان آزادی، پلاک ۲۰۳",
        "تهران، اکباتان، فاز سه، بلوک B، واحد ۷",
        "۵٫۱ کیلومتر", "محمد علوی", "تحویل‌شده", 35.7200, 51.3070),
    Shipment("PASR9987654310", "داریوش صادقی", ShipmentTone.Accent, "در راه", 1,
        "انبار غرب تهران، پونک، بلوار شهید اشرفی اصفهانی، پلاک ۷۸",
        "تهران، شهران، خیابان طاهری، کوچه سوم، پلاک ۱۸",
        "۱٫۸ کیلومتر", "نسرین کریمی", "۸ دقیقه", 35.7700, 51.3630),
    Shipment("PASR1122334455", "پریسا علیزاده", ShipmentTone.Muted, "لغو شد", 0,
        "انبار شرق تهران، بزرگراه رسالت، خروجی هنگام، پلاک ۵۵",
        "تهران، تهران‌پارس، خیابان فرجام، کوچه پنجم، پلاک ۳۳",
        "۲٫۳ کیلومتر", "—", "لغو‌شده", 35.7420, 51.4970),
    Shipment("PASR7788990011", "رامین قاسمی", ShipmentTone.Amber, "در انتظار", 0,
        "انبار مرکزی تهران، خیابان ستارخان، پلاک ۱۶۵",
        "تهران، سیدخندان، خیابان شریعتی، بالاتر از پل سیدخندان، پلاک ۴",
        "۳٫۵ کیلومتر", "مینا رحیمی", "۴۲ دقیقه", 35.7630, 51.4450),
    Shipment("PASR3344556677", "الناز نوروزی", ShipmentTone.Green, "تحویل شد", 2,
        "انبار جنوب تهران، خیابان ری، نزدیک حرم عبدالعظیم، پلاک ۸۹",
        "تهران، ری، خیابان امام خمینی، کوچه هشتم، پلاک ۲۱",
        "۰٫۷ کیلومتر", "سعید منصوری", "تحویل‌شده", 35.5940, 51.4350),
    Shipment("PASR8899001122", "حامد اسماعیلی", ShipmentTone.Accent, "در راه", 1,
        "انبار شمال غرب تهران، صادقیه، بلوار آیت‌الله کاشانی، پلاک ۱۱۲",
        "تهران، جنت‌آباد، خیابان گلستان، کوچه دهم، پلاک ۴۵",
        "۲٫۹ کیلومتر", "فاطمه موسوی", "۲۲ دقیقه", 35.7510, 51.3490),
    Shipment("PASR5566778899", "مژگان طاهری", ShipmentTone.Green, "تحویل شد", 2,
        "انبار مرکزی تهران، خیابان انقلاب، نزدیک دانشگاه تهران، پلاک ۵۱",
        "تهران، بلوار کشاورز، خیابان ۱۶ آذر، کوچه دوم، پلاک ۱۴",
        "۱٫۴ کیلومتر", "رضا نجفی", "تحویل‌شده", 35.6970, 51.3940),
    Shipment("PASR2233445566", "سهراب کمالی", ShipmentTone.Muted, "لغو شد", 0,
        "انبار غرب تهران، جاده مخصوص کرج، کیلومتر ۵، مجتمع صنعتی آرین",
        "تهران، مرزداران، خیابان گوهردشت، کوچه سیزدهم، پلاک ۷۷",
        "۶٫۳ کیلومتر", "—", "لغو‌شده", 35.7560, 51.3470),
)
