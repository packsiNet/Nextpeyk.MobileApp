...
import com.nextpeyk.mobileapp.ui.screens.home.HomeViewModel;
import com.nextpeyk.mobileapp.ui.screens.home.HomeViewModel_HiltModules;
...
public final class DaggerMyApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MyApp_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_nextpeyk_mobileapp_ui_screens_home_HomeViewModel, HomeViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_nextpeyk_mobileapp_ui_screens_home_HomeViewModel = "com.nextpeyk.mobileapp.ui.screens.home.HomeViewModel";

      @KeepFieldType
      HomeViewModel com_nextpeyk_mobileapp_ui_screens_home_HomeViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends MyApp_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_nextpeyk_mobileapp_ui_screens_home_HomeViewModel, ((Provider) homeViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.nextpeyk.mobileapp.ui.screens.home.HomeViewModel 
